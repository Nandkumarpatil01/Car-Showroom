...
public partial class User_Register : System.Web.UI.Page
{
    ...
    protected void btn_sub_Click(object sender, EventArgs e)
    {
        ...
        if (txt_name.Text == "" || txt_mail.Text == "" || txt_mob.Text == "" || txt_pass.Text == "")
        {
        ...
        {
            cmd = new SqlCommand("insert into tbl_reg values('" + txt_name.Text + "','" + txt_mail.Text + "','" + txt_mob.Text + "','" + txt_pass.Text + "')");
            cmd.Connection = con;
